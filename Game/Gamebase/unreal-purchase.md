...
구매하고자 하는 아이템의 gamebaseProductId를 이용해 다음의 API를 호출하여 구매를 요청합니다. 게임 유저가 구매를 취소하는 경우 **PURCHASE\_USER\_CANCELED** 오류가 반환됩니다.
...
Supported Platforms ■ UNREAL\_ANDROID
...
| PURCHASE\_NOT\_SUPPORTED\_MARKET              | 4010       | <p>지원하지 않는 스토어입니다.<br>선택 가능한 스토어는 AS(App Store), GG(Google), ONESTORE, GALAXY입니다.</p>                                 |
