...
| 값               | 타입      | 필수 | 설명                                             |
| --------------- | ------- | -- | ---------------------------------------------- |
| startUpdateDate | String  | 필수 | <p>결과 업데이트 조회 시작 시간<br>yyyy-MM-dd HH:mm:ss</p> |
| endUpdateDate   | String  | 필수 | <p>결과 업데이트 조회 종료 시간<br>yyyy-MM-dd HH:mm:ss</p> |
...
| from        | String | -     | O  | <p>통계 조회 시작 날짜<br>yyyy-MM-dd HH:mm</p>               |
| to          | String | -     | O  | <p>통계 조회 종료 날짜<br>yyyy-MM-dd HH:mm</p>               |
...
| 값         | 타입      | 최대 길이 | 필수 | 설명                                                                                                 |
| --------- | ------- | ----- | -- | -------------------------------------------------------------------------------------------------- |
| wheres    | List    | -     | 옵션 | <p>조회 조건.<br>알파뱃, 숫자, 괄호로 이루어진 문자열 배열.<br>괄호는 1개, AND/OR은 3개까지 사용 가능<br>(예시) tagId1,AND,tagId2</p> |
